...
/******/ 	var hotCurrentHash = "3dc0a2461cfd85c8b956"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactiveClient2 = __webpack_require__(9);
	
	var _reactiveClient = _interopRequireWildcard(_reactiveClient2);
	
	var _clientStore2 = __webpack_require__(10);
	...
	var _domainDrivenStorePersistencePlugin = __webpack_require__(8);
	...
	var Domain = function () {
	    ...
	    _createClass(Domain, [{
	        ...
	        value: function registerSubdomain(_ref2) {
	            ...
	            if ((typeof domain === 'undefined' ? 'undefined' : _typeof(domain)) == 'object') {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _clientStore = __webpack_require__(10);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Fullstack = function (_Composit) {
	    ...
	    function Fullstack(_ref) {
	        ...
	        if (!_strictduck.resolve.satisfies({ provider: persister, dependency: _domainDrivenStorePersistencePlugin2.default })) {
