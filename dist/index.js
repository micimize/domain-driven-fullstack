...
/******/ 	var hotCurrentHash = "109634159eee5620f4a7"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = exports.Domain = exports.clientStore = exports.reactiveClient = exports.server = undefined;
	
	var _server2 = __webpack_require__(4);
	
	var _server = _interopRequireWildcard(_server2);
	
	var _reactiveClient2 = __webpack_require__(8);
	
	var _reactiveClient = _interopRequireWildcard(_reactiveClient2);
	
	var _clientStore2 = __webpack_require__(9);
	...
	var _fullstack = __webpack_require__(11);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function implement(_ref2) {
	    ...
	    return  true ? (0, _strictduck.provides)(_extends({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Domains = exports.Domains = (0, _strictduck.typedMap)({ name: 'Domains', strictduck: Domain });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _clientStore = __webpack_require__(9);
	...
	var implementDependent = (0, _strictduck.implementable)(_strictduck.depends, {
	    ...
	    dependencies: [_Domain2.default, _clientStore2.default]
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _buildDomainDriver = __webpack_require__(10);
	
	var _buildDomainDriver2 = _interopRequireDefault(_buildDomainDriver);
	...
	var ClientStoreDomainDriver = (0, _buildDomainDriver2.default)(ClientStore);
	
	var implementDependent = (0, _strictduck.implementable)(_strictduck.depends, {
	    parent: ClientStoreDomainDriver,
	    dependencies: [_Domain.Domain /*, Store, routes*/]
	});
	...
	exports.default = ClientStoreDomainDriver;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = buildDomainDriver;
	
	var _strictduck = __webpack_require__(5);
	
	function buildDomainDriver(parent) {
	    return (0, _strictduck.extend)({
	...
	var Fullstack = function (_Composit) {
	    ...
	    function Fullstack(_ref) {
	        ...
	        var satisfied = {
	            ...
	            Server: serverSide ? _strictduck.resolve.satisfies({ provider: server, dependency: _server.DomainDrivenServer }) && true : true,
	        ...
	        if (!Object.keys(satisfied).filter(function (v) {
	            ...
	            var main = serverSide ? { Class: _server.DomainDrivenServer, method: 'provide' } : { Class: _client.DomainDrivenClient, method: 'provide' };
	
	            var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Fullstack).call(this, { main: main }, { dependency: _Domain.Domains, provider: domains }, { dependency: _server.DomainDrivenServer, provider: server }, { dependency: _client.DomainDrivenClient, provider: client }));
	        } else {
